...
export const mapBookImage = (image: BookImage): BookImageDto => ({
  ...
  thumbnailUrl: addTransformation(image.secureUrl, 'c_fill,w_180,h_260,g_auto,f_auto,q_auto'),
  coverUrl: addTransformation(image.secureUrl, 'c_fill,w_360,h_520,g_auto,f_auto,q_auto'),
