  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-pale-cream/60 via-white to-library-mist/40">
      ...
      <main className="w-full flex-1 px-3 py-5 sm:px-5 lg:px-8">
        ...
        <section className="mx-auto min-h-[calc(100vh-14rem)] max-w-7xl overflow-hidden rounded-3xl border border-sandy-beige/70 bg-white/90 p-4 shadow-[0_20px_50px_rgba(22,35,28,0.12)] backdrop-blur sm:p-6 lg:p-8">
          <Outlet />
        </section>
      </main>
      <Footer />
