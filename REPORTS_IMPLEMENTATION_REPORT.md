...
This phase implements SRS LMS-FR15: Report Generation. The delivered workflow is a focused issued-book administrative report, matching the SRS scenario where an admin generates an issued-book report.
...
- Status filter supports all, active, returned, and computed overdue records.
...
8. Download CSV and confirm the visible rows are included.
